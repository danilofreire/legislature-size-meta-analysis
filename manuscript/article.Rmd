...
overspend in their districts and transfer the costs to the entire polity. The
first studies that assessed the "law of $1/n$", as the theory is currently
known, mostly found a positive correlation between government spending and the
number of legislature seats, although the effect was sometimes limited to the
lower house [e.g., @baqir1999districts; @bradbury2001legislative;
@gilligan1995deviations]. However, recent studies have questioned the validity
of the theory. For instance, spending limits or strong executives may reduce
the inefficiency of pork barrel projects [@chen_malhotra_2007; @primo2006stop].
