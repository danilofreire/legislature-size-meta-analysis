...
`r round(mod[[4]]$pval.random,3)`, prediction interval = [-1.258; 1.627], $I^2$ = 85.9\%). Although the
...
= [`r round(mod[[7]]$lower.random,3)`; `r round(mod[[7]]$upper.random,3)`], $p$-value = `r round(mod[[7]]$pval.random,3)`, prediction interval = [-0.428; 0.423],
