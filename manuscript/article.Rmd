...
selected articles, `r as.numeric(round(prop.table(table(dat$scoefnd))*100, 0)[4])`\% of them are positive and statistically significant, `r as.numeric(round(prop.table(table(dat$scoefnd))*100, 0)[3])`\%
are positive and statistically insignificant, `r as.numeric(round(prop.table(table(dat$scoefnd))*100, 0)[1])`\% are negative and
statistically insignificant, and `r as.numeric(round(prop.table(table(dat$scoefnd))*100, 0)[2])`\% are negative and statistically
