...
1 paragrafo para collective action problems -- raciocionio no "industrial something of legislatures", que é um paper do weingast
1 para cada problema que o umberto falou
pargrafo final eh o de acumulo de conhecimento

Temos de manter esse mdoelo porque tem muita variancia nos modelos.
É inteligível nao ter nenhum resultado, justamente pq tem *muita* variância.
Quando tinha mais graus de liberdade, dava mais resultado. À medida que fomos colocando mais, diminuiu efeito.

Justificando os null results: 
Erro do weingast: você acha que cria um novo distrito e que o numero de pessoas se mantem fixo. só que diminui a população!!
o modelo do weingast funciona numa situação muito especifica, e mudando ela um tiquinho ja nao funciona mais.

jeitos de avançar a literatura:
ter uma ideia melhor de quais as assumptions você precisa pra funcionar o negocio.
tem mil assumptions entre os 3 custos/beneficios
os 3 componentes podem variar da forma que for. um deles é externalidade (no mercado das firmas que estão no outro lugar e que vão contratar).
e ninguem que fala da lei discute as assumptions!!!
As assumptions são dificeis de mensurar.

Problemas de identificação (desenho). RDs funcionam melhor.
Moreover replicação/acumulo na disciplina basicamente nao existe.
Seria muito surpreendente encontrar resultados dado esse quadro geral, na verdade.

existe um desconforto geral com a teoria mas ninguém toca nos mecanismos.

outro veio teórico:
os papers de RDD sao todos pra PR, mas o paper do weingast nao eh pra PR.
Pra PR, eh preciso relaxar a hipotese do weingast: existem sustemas PR mas que a votação dos caras eh concentrada num territorio. é uma hipotese fraca do weingast para que ela funcione. mas a teoria nao foi feita pra isso.
por ex. 70% dos vereadores em sp têm votacao concentrada por territorio.
mas existe uma big assumption da qual ninguém fala.
se a votacao eh dispersa (geograficamente), a lei do 1/n faz zero sentido.
PR reforça esse mecanismo, que pode estar correlacionado de formas que a teoria nao prevê.

os padroes desse tipo de paper nao eh o mesmo dos papers de experimento.
o nosso paper eh uma meta analise muito mais dificil de fazer do que a da mia costa, em que tem todas as stats e todos os coeficientes reportados bonitinhos.

tem uma seleção de qual modelo vai entrar: modelo mais completo. (maior n, efeito fixo - max possivel, maximo de controle, optimal/intermediate bandwidth do RD, etc).
se tem mais de um modelo que comply com a regra, é o n maior.
para ser comparavel: soh comparar modelos com as mesmas DV e indvar.
na meta-regression, a gente coloca todas as indvars, e nao as depvars. porque soh nos interessa que direção o efeito vai, e nao o tamanho do efeito.

a gente nao tem controle sobre o tamanho/scale da variação. a meta regression eh o melhor que a gente pdoe fazer pra limpar essa variação doida.
forest plots: o que fazemos bem para tornar todas em comparaveis eh ter o good coefficient do modelo, e ter o desvio padrão.
toda vez que fazemos esse tipo de meta analise, o pacote transforma o coeficiente em seu Hedges’ \(g\).

pergunta pode ser: (A) como fazemos para botar no mesmo saco um RD e um panel? resp: isso eh um problea mesmo nas meta analises, mas na meta regressao isso limpa.
(B) coeficientes sao all over the place. como vocês conseguiram comparar cada um?
Daí explicar o procedimento. Na restricted sample, we cherry picked, mas no appendix rodamos a analise com tudo junto pra vc, revisor, ver. 
