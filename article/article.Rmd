...
`r length(unique(dat$id))` studies as of the 21\textsuperscript{st} of November,
2019. Table \ref{tab:papers} contains the full list of articles from which we
...
papers after each review step is available in the Supplementary Material.
...
between log($n$) and public expenditure per capita or between $k$ and the
