...
pkgs <- c('tidyverse', 'meta', 'metafor', 'readxl',
          'dmetar', 'knitr', 'gridGraphics', 'gridExtra','ggpubr','kableExtra')
...
```{r, echo=FALSE, fig.width=7, fig.height=4, fig.cap="Effect of upper house size (K) on the per capita government expenditure (ExpPC)"}
forest(mod, sortvar = -TE, layout = "RevMan5", comb.fixed = FALSE,
       prediction = TRUE, digits.se = 3)
f6 <- grid.grab()
```
...
\newpage
```{r, echo=FALSE, fig.width=16, fig.height=16, warning = F,message = FALSE}
...
\newpage
```{r, echo=FALSE, fig.width=10, fig.height=10, warning = F,message = FALSE,fig.cap="test size"}
...
\newpage
### Summary of results
```{r, echo=FALSE, fig.width=17, fig.height=24}
