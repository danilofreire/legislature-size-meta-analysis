...
f <- ggarrange(f1, f4, f2,
               f3, f6, 
               f7, f5,
               ncol = 3, nrow = 3, 
               hjust = 0, align = 'hv')
ggsave("./plots/fig2.pdf", plot = f, width = 35, height = 25, units = "cm")
```
...
```{r, echo=FALSE, fig.width=12, fig.height=6, fig.cap="Effect of Lower House Size (N) on Per Capita Expenditure (ExpPC)",warning=FALSE}
build_forest(mod, NULL)
```
