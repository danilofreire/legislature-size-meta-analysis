...
6. The institutional design: whether the legislature in the analysis is unicameral or non-unicameral (bicameral or mixed).
...
mod <- rma.mv(yi = coef,
              ...
              method = "REML",
              random = ~ 1 | id_level1/id_level2, 
              mods = ~depvar2+indepvar2+year+published+elecsys2+method+instdesign2,
              test = "knha",
              tdist = TRUE,
              sparse = TRUE,
              slab = dat$authoryear)
