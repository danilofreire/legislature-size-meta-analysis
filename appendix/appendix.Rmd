...
In this section, we present the @weingast1981political theoretical arguments behind the law of 1/n, and their rebuttal by @primo2008distributive. Many of the papers included in this meta-analysis also have their own version of why we need a refined version of the XXXX, but these two papers, in our view, present the most elementary theoretical argument 
...
As the above condition suggests, the law of 1/n holds in specific situations. @primo2008distributive XXXX cost is when the suppose that we have a set of representatives, indexed in districts $i \in \{1, \cdots, n \}$. 
