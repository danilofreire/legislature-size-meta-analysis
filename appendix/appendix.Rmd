...
[^freire]: Independent Researcher, <danilofreire@gmail.com>, <https://danilofreire.github.io>. Corresponding author.
...
```{r, size="footnotesize", warning=F, message=F, echo = FALSE, cache=TRUE}
